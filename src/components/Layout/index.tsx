         ...
         >
            {showCircles && (
               <div className="absolute top-0 left-0 right-0">
                  <div className="absolute top-0 right-2/3 overflow-visible opacity-50 dark:opacity-30">
                     <div className="circle-background absolute h-[900px] w-[700px] rounded-[40rem] mix-blend-multiply"></div>
                  </div>

                  <div className="absolute top-0 left-56 overflow-visible opacity-50 dark:opacity-30">
