   ...
   return (
      <Layout showCircles>
         ...
         >
            ...
            >
               <span className="text-indigo-600">iEdu</span>
            </h2>
            <div className="mt-8 flex lg:mt-16 justify-center">
               <Card className='shadow-2xl p-10 rounded-3xl bg-transparent w-[464px] h-[484px]'>
                  ...
                  <CardFooter>
                     <button type="submit" className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br border border-gray-300 text-xl font-semibold rounded-2xl block w-full p-3 mb-5 shadow-xl">Login</button>
                  </CardFooter>
               </Card>
            </div>
         </div>
